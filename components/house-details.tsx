            ...
            <AlertDialogDescription className="text-gray-600 text-lg leading-relaxed">
              {saveNotificationType === 'saved' ? (
                <>
                  ...
                  <br /><br />
                  <span className="text-sm text-gray-500">💡 It will be available for 24 hours, then automatically removed.</span>
                </>
              ) : (
                <>
                  This property has been <span className="font-semibold text-red-600">removed</span> from your saved list.
                  <br /><br />
                  <span className="text-sm text-gray-500">💡 You can save it again anytime!</span>
                </>
              )}
              ...
              <CardContent className="p-6">
                ...
                <div className="mb-6 p-4 bg-gradient-to-r from-blue-50 to-indigo-50 rounded-xl border border-blue-200">
                  ...
                  <p className="text-xs text-gray-600 mt-2 text-center">
                    💡 Saved properties are available for 24 hours
                  </p>
                </div>
                  ...
                  <div className="bg-gray-50 p-4 rounded-lg space-y-3">
                    <div className="flex items-center justify-between">
                      <div>
                        ...
                        <p className="text-lg font-semibold text-gray-800">{house.agent.phone}</p>
                      </div>
                      <Button
                        variant="outline"
                        size="sm"
                    ...
                    <div className="flex items-center justify-between">
                      <div>
                        ...
                        <p className="text-lg font-semibold text-gray-800">{house.agent.whatsapp}</p>
                      </div>
                      <Button
                        variant="outline"
                        size="sm"
